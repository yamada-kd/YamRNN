...
#	rnn=tf.keras.layers.RNN(SLSTMCell(4),return_sequences=True)
#	rnn=tf.keras.layers.Bidirectional(tf.keras.layers.RNN(SLSTMCell(4,dropout=0.3),return_sequences=True))
