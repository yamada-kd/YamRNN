...
def main():
	...
	W10b=theano.shared(value=np.asarray(np.random.uniform(low=-DISTPARAMETER,high=DISTPARAMETER,size=(RNNUNITSIZE)),dtype=theano.config.floatX),name="W10b")
...
# forward
def forward(x,vh,W10a,W10b,b10):
	vh=T.tanh(T.dot(x,W10a)+b10+vh*W10b)
	return vh
