...
def main():
	...
	W1aa=theano.shared(value=np.asarray(np.random.uniform(low=-DISTPARAMETER,high=DISTPARAMETER,size=(EMBEDUNIT,RNNUNITSIZE)),dtype=theano.config.floatX),name="W1aa")
	W1ai=theano.shared(value=np.asarray(np.random.uniform(low=-DISTPARAMETER,high=DISTPARAMETER,size=(EMBEDUNIT,RNNUNITSIZE)),dtype=theano.config.floatX),name="W1ai")
	W1af=theano.shared(value=np.asarray(np.random.uniform(low=-DISTPARAMETER,high=DISTPARAMETER,size=(EMBEDUNIT,RNNUNITSIZE)),dtype=theano.config.floatX),name="W1af")
	W1ao=theano.shared(value=np.asarray(np.random.uniform(low=-DISTPARAMETER,high=DISTPARAMETER,size=(EMBEDUNIT,RNNUNITSIZE)),dtype=theano.config.floatX),name="W1ao")
	...
	b1i=theano.shared(value=np.asarray(np.random.uniform(low=-DISTPARAMETER,high=DISTPARAMETER,size=(RNNUNITSIZE)),dtype=theano.config.floatX),name="b1i")
	b1f=theano.shared(value=np.asarray(np.random.uniform(low=-DISTPARAMETER,high=DISTPARAMETER,size=(RNNUNITSIZE)),dtype=theano.config.floatX),name="b1f")
	b1o=theano.shared(value=np.asarray(np.random.uniform(low=-DISTPARAMETER,high=DISTPARAMETER,size=(RNNUNITSIZE)),dtype=theano.config.floatX),name="b1o")
	W1ba=theano.shared(value=np.asarray(np.random.uniform(low=-DISTPARAMETER,high=DISTPARAMETER,size=(RNNUNITSIZE,RNNUNITSIZE)),dtype=theano.config.floatX),name="W1ba")
	W1bi=theano.shared(value=np.asarray(np.random.uniform(low=-DISTPARAMETER,high=DISTPARAMETER,size=(RNNUNITSIZE,RNNUNITSIZE)),dtype=theano.config.floatX),name="W1bi")
	W1bf=theano.shared(value=np.asarray(np.random.uniform(low=-DISTPARAMETER,high=DISTPARAMETER,size=(RNNUNITSIZE,RNNUNITSIZE)),dtype=theano.config.floatX),name="W1bf")
	W1bo=theano.shared(value=np.asarray(np.random.uniform(low=-DISTPARAMETER,high=DISTPARAMETER,size=(RNNUNITSIZE,RNNUNITSIZE)),dtype=theano.config.floatX),name="W1bo")
